...
def findFrames(c_lon, c_lat, box_s_eq, fdata):
    """
    """
    ...
    r2 = (xmax_cl, ymin_cl)
    frame_intersec = []
    for i, xmin_fr_i in enumerate(l_min):
        # Top left
        l1 = (xmin_fr_i, b_max[i])
        # Bottom right
        r1 = (l_max[i], b_min[i])
